...
@media(max-width:760px){#pipelineActivityCard{padding:8px}.pipeline-activity-head{gap:4px}.pipeline-week-control{width:100%;justify-content:space-between}.pipeline-week-control select{flex:0 1 165px;max-width:165px}.pipeline-activity-grid{grid-template-columns:125px repeat(7,31px) 40px;gap:2px}.pa-head,.pa-label,.pa-cell,.pa-total{height:11px;min-height:11px;border-radius:2px}.pa-head,.pa-label,.pa-cell,.pa-total{font-size:7px}.pa-label{padding:0 2px}}
'''
