...
.outcome-activity-row{grid-column:1/-1;display:grid;grid-template-columns:minmax(0,1.65fr) minmax(445px,1fr);gap:10px;align-items:start}
#outcomeCard,#pipelineActivityCard{min-width:0}
...
@media(max-width:760px){.outcome-activity-row{grid-template-columns:1fr;gap:8px}#pipelineActivityCard{padding:8px}.pipeline-activity-head{gap:4px}.pipeline-week-control{width:auto;justify-content:flex-end}.pipeline-week-control select{flex:0 1 165px;max-width:165px}.pipeline-activity-grid{grid-template-columns:125px repeat(7,31px) 40px;gap:2px}.pa-head,.pa-label,.pa-cell,.pa-total{height:11px;min-height:11px;border-radius:2px}.pa-head,.pa-label,.pa-cell,.pa-total{font-size:7px}.pa-label{padding:0 2px}.pipeline-activity-note{white-space:normal}}
'''
